...
This class is for the Green taxi CSV
'''

class GreenTaxiServiceModel:
    ...
    FieldNames = [VENDOR_ID_KEY, LPEP_PICKUP_DATETIME_KEY, LPEP_DROPOFF_DATETIME_KEY, WAS_STORED_AND_FORWARDED_KEY, RATECODE_ID_KEY, PU_LOCATION_ID_KEY, DO_LOCATION_ID_KEY, PASSENGER_COUNT_KEY,
                  TRIP_DISTANCE_KEY, FARE_AMOUNT_KEY, EXTRA_KEY, MTA_TAX_KEY, TIP_AMOUNT_KEY, TOLLS_AMOUNT_KEY, EHAIL_FEE_KEY, IMPROVEMENT_SURCHARGE_KEY, TOTAL_AMOUNT_KEY, PAYMENT_TYPE_KEY, TRIP_TYPE_KEY]
